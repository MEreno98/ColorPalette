        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-1">
                <ul class="nav navbar-nav">
                    ...
                    <li <?php if(basename($_SERVER['PHP_SELF'])=="palette.php"){echo 'class="active"';}?>><a href="palette.php">Palette</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <section class="jumbotron">
        <?php
            if(basename($_SERVER['PHP_SELF'])=="index.php"){
                echo '<div class="container text-center"><img src="img/logo.png" alt="logo" class="imgJBT"><p>ColorssPalette</p></div>';
